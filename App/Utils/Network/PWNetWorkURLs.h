...
#pragma mark ========== 登录/注册 ==========
// 登录接口 获取token
#define PW_login          [NSString stringWithFormat:@"%@/v3/auth/token", API_HOST]
// 发送验证码
#define PW_sendAuthCode       [NSString stringWithFormat:@"%@/v3/auth/sms_verify_code_old", API_HOST]
// 验证码验证
#define PW_checkCode       [NSString stringWithFormat:@"%@/v3/auth/phone_sms_verify", API_HOST]
// 设备上短信数量
#define PW_smsCount        [NSString stringWithFormat:@"%@/v3/auth/sms_count/${deviceId}", API_HOST]
