...
//    [self.view addSubview:self.titleLabel];
    ...
    CGFloat height = ZOOM_SCALE(30);
    CGFloat width = ZOOM_SCALE(60);
//    [self.bottomLabel setFrame:CGRectMake(0, _selfHeight-44,_selfWidth, 44)];
    [self.cancleButton setFrame:CGRectMake(26, _selfHeight - kTabBarHeight,width, height)];
    [self.sureButton setFrame:CGRectMake(_selfWidth - 26- width, _selfHeight - kTabBarHeight, width, height)];
...
-(UIButton *)cancleButton{
    if (!_cancleButton) {
        ...
        [_cancleButton setTitle:NSLocalizedString(@"local.cancel", @"") forState:UIControlStateNormal];
