 ...
 *  @param gesture 手势结果
 */
- (void)circleView:(PWCircleView *)view type:(CircleViewType)type connectCirclesLessThanNeedWithGesture:(NSString *)gesture;
 ...
 */
- (void)circleView:(PWCircleView *)view type:(CircleViewType)type didCompleteSetFirstGesture:(NSString *)gesture;
 ...
 */
- (void)circleView:(PWCircleView *)view type:(CircleViewType)type didCompleteSetSecondGesture:(NSString *)gesture result:(BOOL)equal;
 ...
 */
- (void)circleView:(PWCircleView *)view type:(CircleViewType)type didCompleteLoginGesture:(NSString *)gesture result:(BOOL)equal;
