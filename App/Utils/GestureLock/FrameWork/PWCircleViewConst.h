 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor RGBACOLOR(13,52,89,1)

/**
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor RGBACOLOR(241,241,241,1)

/**
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor RGBACOLOR(34,178,246,1)

/**
 *  错误状态下外空心圆颜色
 */
#define CircleStateErrorOutsideColor RGBACOLOR(254,82,92,1)
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor RGBACOLOR(34,178,246,1)

/**
 *  错误状态内实心圆颜色
 */
#define CircleStateErrorInsideColor RGBACOLOR(254,82,92,1)
 ...
 *  选中状态下三角形颜色
 */
#define CircleStateSelectedTrangleColor RGBACOLOR(34,178,246,1)

/**
 *  错误状态三角形颜色
 */
#define CircleStateErrorTrangleColor RGBACOLOR(254,82,92,1)
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor RGBACOLOR(34,178,246,1)

/**
 *  错误时连线颜色
 */
#define CircleConnectLineErrorColor RGBACOLOR(254,82,92,1)
 ...
 */
#define CircleViewCenterY kHeight * 3/5
...
@interface PWCircleViewConst : NSObject
