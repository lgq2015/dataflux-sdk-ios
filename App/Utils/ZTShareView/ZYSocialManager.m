...
- (void)showAlter:(NSString *)title{
    ...
    UIAlertAction *confirm = [UIAlertAction actionWithTitle:NSLocalizedString(@"local.confirm", @"") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
