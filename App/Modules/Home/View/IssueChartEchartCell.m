...
-(void)setModel:(ClassifyModel *)model{
    ...
    if (model.echartDatas) {
        if (!_echartView) {
               _echartView = [[EchartView alloc]initWithDict:model.echartDatas smooth:YES];
               ...
               [self.echartView refreshEchartsWithNewData:model.echartDatas smooth:YES];
           }
