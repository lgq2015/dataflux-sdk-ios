...
- (void)refreshEchartsWithNewData:(NSDictionary *)data{
    ...
    __block  NSMutableArray *lineX  = [NSMutableArray new];
     ...
     self.option.titleEqual([PYTitle initPYTitleWithBlock:^(PYTitle *title) {
     ...
     // 添加到图标选择中
     self.option.xAxis = [[NSMutableArray alloc] initWithObjects:xAxis, nil];
     ...
     self.option.yAxis = [[NSMutableArray alloc] initWithObjects:yAxis, nil];
