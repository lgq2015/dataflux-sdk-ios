...
@interface LibraryDraggableItem ()<UIGestureRecognizerDelegate>
...
@end
@implementation LibraryDraggableItem
#pragma mark -
...
- (void)setBtnArray:(NSMutableArray *)btnArray
{
    ...
    for (LibraryDraggableItem *btn in btnArray) {
...
//  调整按钮位置
- (void)adjustItems:(LibraryDraggableItem *)dragBtn index:(NSInteger)index {
