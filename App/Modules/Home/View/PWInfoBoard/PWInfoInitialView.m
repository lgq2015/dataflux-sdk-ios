...
- (void)setUpUI{
    ...
    if (!self.tipsTitle) {
        _tipsTitle = [[UILabel alloc]initWithFrame:CGRectMake(ZOOM_SCALE(20), ZOOM_SCALE(23), ZOOM_SCALE(296), ZOOM_SCALE(25))];
        _tipsTitle.text = @"还在为无法发现 IT 问题而烦恼？";
        _tipsTitle.font = [UIFont systemFontOfSize:18];
        [self addSubview:_tipsTitle];
    }
    if (!self.tipsContent) {
        _tipsContent = [[UILabel alloc]initWithFrame:CGRectMake(ZOOM_SCALE(20), ZOOM_SCALE(64), ZOOM_SCALE(300), ZOOM_SCALE(40))];
    ...
    NSArray *btnImag = @[@"monitoring",@"safe",@"consume",@"optimize"];
    NSArray *iconNames = @[@"监控",@"安全",@"费用",@"优化"];
    for (int i=0; i<4; i++) {
        UIImageView *imgView = [[UIImageView alloc]initWithFrame:CGRectMake(ZOOM_SCALE(61+i*61), ZOOM_SCALE(133), ZOOM_SCALE(30), ZOOM_SCALE(30))];
        imgView.tag = i+10;
        UILabel *iconName = [[UILabel alloc]initWithFrame:CGRectMake(ZOOM_SCALE(61+i*61), ZOOM_SCALE(169), ZOOM_SCALE(34), ZOOM_SCALE(22))];
    ...
    UIView *lines = [[UIView alloc]initWithFrame:CGRectMake(ZOOM_SCALE(20), ZOOM_SCALE(213), ZOOM_SCALE(296), ZOOM_SCALE(1))];
    ...
    UIButton *serverConnectbtn = [[UIButton alloc]initWithFrame:CGRectMake(ZOOM_SCALE(100), ZOOM_SCALE(232), ZOOM_SCALE(136), ZOOM_SCALE(22))];
