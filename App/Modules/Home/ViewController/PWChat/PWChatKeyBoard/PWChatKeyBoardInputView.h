...
@end
@interface PWChatKeyBoardInputView : UIView<UITextViewDelegate,PWChatKeyBordViewDelegate>
...
//传入底部视图进行frame布局
@property (strong, nonatomic) PWChatKeyBordView   *mKeyBordView;
