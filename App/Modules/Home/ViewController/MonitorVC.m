...
- (void)createUI{
    ...
    NSArray *array = @[@{@"title":@"您的 ECS 还有5天过期几几年就能了立刻就看两节课老家看了",@"time":@"30分钟前",@"state":@"1",@"suggestion":@"张三：可能需要寻求协助，大家意见保持保持保持保…",@"attrs":@"仅剩5天过期"},@{@"title":@"您的 ECS 还有5天过期您的 ECS 还有5天",@"time":@"30分钟前",@"state":@"2",@"suggestion":@"张三：可能需要寻求协助，大家意见保持保持保持保…",@"attrs":@"仅剩5天过期"},@{@"title":@"您的 ECS 还有5天过期",@"time":@"30分钟前",@"state":@"3",@"suggestion":@"张三：可能需要寻求协助，大家意见保持保持保持保…",@"attrs":@"仅剩5天过期"},@{@"title":@"您的 ECS 还有5天过期您的 ECS 还有5天过期几几年就能了立您的 ECS 还有5天过期几几年就能了立您的 ECS 还有5天过期几几年就能了立您的 ECS 还有5天过期几几年就能了立您的 ECS 还有5天过期几几年就能了立",@"time":@"30分钟前",@"state":@"4",@"suggestion":@"张三：可能需要寻求协助，大家意见保持保持保持保…"}];
