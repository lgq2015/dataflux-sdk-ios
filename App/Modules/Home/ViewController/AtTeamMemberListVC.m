...
- (void)createUI{
    ...
    [self addNavigationItemWithTitles:@[NSLocalizedString(@"local.MultiSelect", @"")] isLeft:NO target:self action:@selector(chooseMoreClick) tags:@[@11]];
...
- (void)chooseMoreClick{
    ...
    UIButton *button = [PWCommonCtrl buttonWithFrame:CGRectZero type:PWButtonTypeContain text:NSLocalizedString(@"local.confirm", @"")];
