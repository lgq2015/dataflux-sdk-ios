...
- (void)createUI{
    ...
    UILabel *versonLab = [PWCommonCtrl lableWithFrame:CGRectZero font:RegularFONT(14) textColor:PWTitleColor text:[NSString stringWithFormat:@"%@ %@",NSLocalizedString(@"local.ProWang", @""),version]];
