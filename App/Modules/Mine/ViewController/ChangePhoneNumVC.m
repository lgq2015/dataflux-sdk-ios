...
- (void)crateUI{
    UILabel *title = [PWCommonCtrl lableWithFrame:CGRectMake(10, kTopHeight+Interval(16), ZOOM_SCALE(120), ZOOM_SCALE(37)) font:BOLDFONT(26) textColor:PWTextBlackColor text:@"修改手机"];
