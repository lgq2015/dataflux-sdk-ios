...
- (void)s_UI{
    ...
    NSArray *btnName = @[NSLocalizedString(@"local.TeamInviteMembers", @""),NSLocalizedString(@"local.issueSource", @""),NSLocalizedString(@"local.TeamManagement", @""),NSLocalizedString(@"local.notificationRule", @"")];
